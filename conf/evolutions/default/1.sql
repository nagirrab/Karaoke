...
create table "sessions" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL,"password" VARCHAR(254),"auto_approve" BOOLEAN NOT NULL,"auto_order" BOOLEAN NOT NULL,"notes" VARCHAR(254) NOT NULL);
create table "singers" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(254) NOT NULL,"user_id" BIGINT);
